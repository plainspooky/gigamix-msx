; DM-system2  [Device Driver for Magical Labyrinth]
...
;		 0....5....10...15...20...25...30...35...
	DEFM	'忍!'
	DEFB	1AH
LABY1P:	DEFB	0	;0  = Key Board 1
LABY2P:	DEFB	1	;1  = Key Board 2
LABY3P:	DEFB	2	;2~9= Ninja Tap
LABY4P:	DEFB	3	;10 = Computer(?)

MATTBL:	DEFB	2+0E5H,10H, 2+0E5H,20H, 0EEH,0FFH, 0EEH,0FFH	;A B x x
	DEFB	8+0E5H,20H, 8+0E5H,40H, 8+0E5H,10H, 8+0E5H,80H	;U D L R

	DEFB	7+0E5H,08H, 6+0E5H,02H, 0EEH,0FFH, 0EEH,0FFH	;A B x x
	DEFB	3+0E5H,04H, 3+0E5H,02H, 5+0E5H,01H, 3+0E5H,08H	;U D L R
